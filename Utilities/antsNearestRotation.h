...
// solve Wahba's problem. Prefers the Eigen-backed itk::unsupported::Math::SVD when
...
// itkUnsupportedMathSVD.h is the tiered spelling (ITK >= 6.0 after the
// itk::unsupported::Math move); itkMathSVD.h is the pre-move name. Probing the
// new path first keeps both ITK vintages on the Eigen path.
#if __has_include(<itkUnsupportedMathSVD.h>)
#  include "itkUnsupportedMathSVD.h"
#  ifndef ANTS_HAS_ITK_MATH_SVD
#    define ANTS_HAS_ITK_MATH_SVD 1
#  endif
#  ifndef ANTS_ITK_MATH_NS
#    define ANTS_ITK_MATH_NS itk::unsupported::Math
#  endif
