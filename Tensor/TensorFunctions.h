...
#if __has_include(<itkUnsupportedMathLDLT.h>)
#  include <itkUnsupportedMathLDLT.h>
...
namespace matHelper
{
// Inverse of a SYMMETRIC matrix. With itk::unsupported::Math::SolveSymmetric available, build
...
{
#if defined(ITK_UNSUPPORTED_MATH_HAS_SOLVE_SYMMETRIC)
  return itk::unsupported::Math::InverseSymmetric(A);
